public class SingleMain {
   public static void main(String[] args) {
    ...
    u1.showUserDetail();
    System.out.println("-------------------");
    // When creating object pf Customer, it carries both User & Customer class properties
    System.out.println("Customer properties");
    Customer c1 = new Customer();
    c1.customer_id =1;
    c1.email = "hitesh@gmail.com";
    c1.contact = "983456787";
    c1.current_address = "Dhobigaht, Lalitpur";
    System.out.println("It show properties of User NULL because no data assigned..");
